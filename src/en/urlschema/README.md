...
> scheme:xff  
> host:open.fchain.io
 2. web+stellar://, about pay and tx, ref to[SEP0007](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0007.md)
 notice, SEP0007 might be too complex, not sure if we support it or not, xff protocol is first class.
...
|Operation name|Protocol applied|Implemented or not|Charge or not|Priority|
|:---|:---|:---|:---|:---|
|Start APP|XFF|√|×|H|
|Create wallet account|XFF|√|×|L|
|Show quotes|XFF|√|√|H|
|Add contact|XFF|×|√|M|
|Trust|XFF, web+stellar|×|×|M|
|Payment|XFF, web+stellar|×|×|H|
|Pathpayment|XFF, web+stellar|x|x|L|
|Sign TX|XFF, web+stellar|×|×|H|
|Deposit|XFF|×|√|M|
|Withdraw|XFF|×|√|M|
|Set inflation pool|XFF|×|√|M|
|Open DAPP detail|XFF|√|×|M|
|Open DAPP|XFF|√|×|M|
|Open red package|XFF|×|×|H|
|Claim red package|XFF|×|×|H|
|Check red package records, send red package|XFF|×|×|H|
|Open certain asset detail|XFF|×|×|L|
|Scan QR to login|https|×|√|H|
